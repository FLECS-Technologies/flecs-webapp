...
const EnvironmentVariableCard: React.FC<EnvironmentVariableCardProps> = ({
  ...
  return (
    <div
      className={`flex items-center gap-3 px-4 py-3 hover:bg-white/3 transition ${isNew ? 'border-l-[3px] border-l-success' : isModified ? 'border-l-[3px] border-l-warning' : 'border-l-[3px] border-l-transparent'}`}
    >
      <input
      ...
      <button
        ...
        className="p-1.5 rounded-lg hover:bg-white/10 transition text-muted hover:text-error"
