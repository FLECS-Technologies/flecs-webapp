...
const SuperAdminStepComponent: React.FC<{ onNext?: () => void; onComplete?: () => void }> = ({
  onNext,
  onComplete,
}) => {
    ...
    <div className="max-w-xl mx-auto">
      ...
      >
        ...
        <p className="text-sm text-muted mb-6">
          Create the initial administrator account for your device.
        </p>
        ...
        <div className="flex justify-between mt-8">
          <button
            ...
            disabled={isPending}
          >
            {isPending ? 'Creating Admin...' : 'Create Administrator'}
          </button>
        </div>
        {mutationError && (
          <div className="px-4 py-3 rounded-lg bg-error/10 text-error mt-4">
