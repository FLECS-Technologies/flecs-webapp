...
import webappSbomCycloneDxHref from '@assets/sbom.cyclonedx.json?url';
import webappSbomSpdxHref from '@assets/sbom.spdx.json?url';
...
// Generated by `npm run sbom`; also published unhashed at /sbom.<format>.json.
const webappFiles: Record<SbomFormat, { filename: string; href: string }> = {
  spdx: { filename: 'webapp.sbom.spdx.json', href: webappSbomSpdxHref },
  cyclonedx: { filename: 'webapp.sbom.cyclonedx.json', href: webappSbomCycloneDxHref },
};
