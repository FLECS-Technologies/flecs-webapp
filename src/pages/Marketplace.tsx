      ...
      >
        ...
        <Chip
          ...
          sx={{
            ...
            fontWeight: 600,
            borderRadius: 2,
            borderColor: filterParams.available ? 'transparent' : 'divider',
            bgcolor: filterParams.available ? 'primary.main' : 'transparent',
            color: filterParams.available ? '#fff' : 'text.secondary',
            '&:hover': {
              bgcolor: filterParams.available ? 'primary.dark' : 'action.hover',
            },
          }}
        />
        <Chip
