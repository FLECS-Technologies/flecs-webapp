...
vi.mock('@app/api/ApiProvider', () => ({
  useProtectedApi: vi.fn(),
}));

// Import the modules after mocking
import { useProtectedApi } from '@app/api/ApiProvider';
import DeviceActivationProvider from '../DeviceActivationProvider';
import { DeviceActivationContext } from '@features/auth/contexts/DeviceActivationContext';
