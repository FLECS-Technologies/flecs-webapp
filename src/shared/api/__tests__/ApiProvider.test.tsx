...
// Mock the Configuration class — must behave like a constructor (new Configuration(...))
vi.mock('@flecs/core-client-ts', () => {
  const MockConfiguration = vi.fn(function (this: any, config: any) {
...
describe('ApiProvider', () => {
  ...
  beforeEach(() => {
    ...
    mockConfiguration.mockImplementation(function (this: any, config: any) {
      Object.assign(this, config);
    });
