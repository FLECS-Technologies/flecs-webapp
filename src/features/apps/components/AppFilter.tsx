      ...
      <Box sx={{ margin: 1, padding: 1 }}>
        <Box sx={{ mb: 1 }}>
          ...
          <Button
            ...
            endIcon={availableFilter ? <X size={16} /> : <PlusCircle size={16} />}
          >
        ...
        {search && (
          <Box sx={{ mt: 2, mb: 1 }}>
            ...
            <Button
              ...
              endIcon={!isSearchEnabled ? <PlusCircle size={16} /> : <X size={16} />}
        ...
        <Box sx={{ mt: 2, mb: 1 }}>
          ...
          {categories?.map((c) => (
            <Button
              ...
              endIcon={
                hiddenCategories.includes(c.id) ? <PlusCircle size={16} /> : <X size={16} />
              }
              key={c.id}
