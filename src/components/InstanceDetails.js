    ...
    <TableContainer aria-label='instance-details-container'>
        ...
        <Table sx={{ minWidth: 650 }} aria-label="network info table">
            ...
            <TableBody>
                ...
                {(instanceDetails?.ports?.length > 0) && <CollapsableRow title='Ports'>
        ...
        <Table>
            ...
            <TableBody>
                {(instanceDetails?.volumes?.length > 0) && <CollapsableRow title='Volumes'>
                    <VolumesTable volumes={instanceDetails?.volumes}></VolumesTable>
                </CollapsableRow>}
                {(instanceDetails?.conffiles?.length > 0) && <CollapsableRow title='Configuration Files'>
                    <HostContainerTable data={instanceDetails?.conffiles}></HostContainerTable>
                </CollapsableRow>}
                {(instanceDetails?.mounts?.length > 0) && <CollapsableRow title='Mounts'>
