...
This folder is a developer preview of the white-label runtime contract. Real customer
brand files live in the private white-label repository and are injected into the webapp
