import { decodeHtmlEntities, sanitizeHtml } from '@app/utils/html-utils';
...
export const getEditorAddress = (app: WCProduct) => attr(app, 'editor')?.[0];
export const getMultiInstance = (app: WCProduct) => !!attr(app, 'multiInstance')?.[0];
